import {
  zIndex_default
} from "./chunk-SCBJQUNK.js";
import {
  require_prop_types
} from "./chunk-HZC22DSZ.js";
import {
  require_jsx_runtime
...
var getSourceMap;
{
  ...
  getSourceMap = function getSourceMap3(styles) {
...
// node_modules/@mui/styled-engine/node_modules/@emotion/sheet/dist/emotion-sheet.development.esm.js
...
var StyleSheet2 = function() {
  function StyleSheet3(options) {
    ...
    this.isSpeedy = options.speedy === void 0 ? !isDevelopment4 : options.speedy;
    this.tags = [];
    this.ctr = 0;
    this.nonce = options.nonce;
    this.key = options.key;
  ...
  do {
    switch (token(character2)) {
      case 0:
        ...
        parsed[index] += identifierWithPointTracking3(position - 1, points, index);
        break;
      case 2:
        parsed[index] += delimit(character2);
        break;
...
var getRules3 = function getRules4(value, points) {
  return dealloc(toRules3(alloc(value), points));
};
...
var createUnsafeSelectorsAlarm3 = function createUnsafeSelectorsAlarm4(cache) {
  return function(element, index, children) {
    if (element.type !== "rule" || cache.compat) return;
    var unsafePseudoClasses = element.value.match(/(:first|:nth|:nth-last)-child/g);
    if (unsafePseudoClasses) {
...
{
  sourceMapPattern = /\/\*#\ssourceMappingURL=data:application\/json;\S+\s+\*\//g;
  getSourceMap2 = function getSourceMap3(styles) {
    var matches = styles.match(sourceMapPattern);
    if (!matches) return;
    return matches[matches.length - 1];
  };
...
var createCache3 = function createCache4(options) {
  ...
  }
  {
    ...
    _insert = function insert(selector, serialized, sheet, shouldCache) {
      currentSheet = sheet;
      if (getSourceMap2) {
        var sourceMap = getSourceMap2(serialized.styles);
        if (sourceMap) {
          currentSheet = {
            insert: function insert2(rule) {
              sheet.insert(rule + sourceMap);
...
var createEmotionCache = (options, CustomSheet) => {
  const cache = createCache3(options);
...
function getCache(injectFirst, enableCssLayer) {
  if (injectFirst || enableCssLayer) {
    class MyStyleSheet extends StyleSheet2 {
      insert(rule, options) {
  ...
  if (Array.isArray(obj)) {
    ...
    for (var key in obj) {
      ...
      if (typeof value !== "object") {
        ...
        if (key === "NO_COMPONENT_SELECTOR" && isDevelopment5) {
          throw new Error(noComponentSelectorMessage2);
        }
        if (Array.isArray(value) && typeof value[0] === "string" && (registered == null || registered[value[0]] === void 0)) {
          for (var _i = 0; _i < value.length; _i++) {
...
var registerStyles3 = function registerStyles4(cache, serialized, isStringTag2) {
  var className = cache.key + "-" + serialized.name;
  if (
    // we only need to add the styles to the registered cache if the
    // class name could be used further down
...
var insertStyles3 = function insertStyles4(cache, serialized, isStringTag2) {
  registerStyles3(cache, serialized, isStringTag2);
  var className = cache.key + "-" + serialized.name;
  if (cache.inserted[serialized.name] === void 0) {
    var current = serialized;
    do {
...
var Insertion5 = function Insertion6(_ref) {
  ...
  registerStyles3(cache, serialized, isStringTag2);
  useInsertionEffectAlwaysWithSyncFallback(function() {
    return insertStyles3(cache, serialized, isStringTag2);
  });
  return null;
};
  ...
  return function() {
    ...
    Object.defineProperty(Styled, "toString", {
      value: function value() {
        if (targetClassName === void 0 && isDevelopment6) {
...
// node_modules/@mui/styled-engine/node_modules/@emotion/unitless/dist/emotion-unitless.esm.js
var unitlessKeys3 = {
  animationIterationCount: 1,
  aspectRatio: 1,
  borderImageOutset: 1,
...
// node_modules/@mui/styled-engine/node_modules/@emotion/serialize/dist/emotion-serialize.development.esm.js
var isDevelopment7 = true;
var ILLEGAL_ESCAPE_SEQUENCE_ERROR4 = `You have illegal escape sequence in your template literal, most likely inside content's property value.
Because you write your CSS inside a JavaScript string you actually have to do double escaping, so for example "content: '\\00d7';" should become "content: '\\\\00d7';".
You can read more about this here:
https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Template_literals#ES2018_revision_of_illegal_escape_sequences`;
var UNDEFINED_AS_OBJECT_KEY_ERROR3 = "You have passed in falsy value as style object's key (can happen when in example you pass unexported component as computed key).";
var hyphenateRegex3 = /[A-Z]|^ms/g;
var animationRegex3 = /_EMO_([^_]+?)_([^]*?)_EMO_/g;
var isCustomProperty5 = function isCustomProperty6(property) {
  return property.charCodeAt(1) === 45;
};
var isProcessableValue5 = function isProcessableValue6(value) {
  return value != null && typeof value !== "boolean";
};
var processStyleName3 = memoize(function(styleName) {
  return isCustomProperty5(styleName) ? styleName : styleName.replace(hyphenateRegex3, "-$&").toLowerCase();
});
var processStyleValue5 = function processStyleValue6(key, value) {
  switch (key) {
    case "animation":
    case "animationName": {
      if (typeof value === "string") {
        return value.replace(animationRegex3, function(match2, p1, p2) {
          cursor3 = {
            name: p1,
            styles: p2,
            next: cursor3
  ...
  if (unitlessKeys3[key] !== 1 && !isCustomProperty5(key) && typeof value === "number" && value !== 0) {
    return value + "px";
  }
  return value;
};
...
var hyphenPattern;
var hyphenatedCache;
var noComponentSelectorMessage3 = "Component selectors can only be used in conjunction with @emotion/babel-plugin, the swc Emotion plugin, or another Emotion-aware compiler transform.";
function handleInterpolation3(mergedProps, registered, interpolation) {
  if (interpolation == null) {
    return "";
  }
  var componentSelector = interpolation;
  if (componentSelector.__emotion_styles !== void 0) {
    if (String(componentSelector) === "NO_COMPONENT_SELECTOR") {
      throw new Error(noComponentSelectorMessage3);
    }
    return componentSelector;
  }
  switch (typeof interpolation) {
    ...
    case "object": {
      ...
      return createStringFromObject3(mergedProps, registered, interpolation);
    }
    case "function": {
      if (mergedProps !== void 0) {
        ...
        return handleInterpolation3(mergedProps, registered, result);
      } else {
        console.error("Functions that are interpolated in css calls will be stringified.\nIf you want to have a css call based on props, create a function that returns a css call like this\nlet dynamicStyle = (props) => css`color: ${props.color}`\nIt can be called directly with props or interpolated in a styled call like this\nlet SomeComponent = styled('div')`${dynamicStyle}`");
      }
      break;
    ...
    case "string":
      {
        var matched = [];
        var replaced = interpolation.replace(animationRegex3, function(_match, _p1, p2) {
          var fakeVarName = "animation" + matched.length;
          matched.push("const " + fakeVarName + " = keyframes`" + p2.replace(/^@keyframes animation-\w+/, "") + "`");
          return "${" + fakeVarName + "}";
        });
...
function createStringFromObject3(mergedProps, registered, obj) {
  var string = "";
  if (Array.isArray(obj)) {
    for (var i = 0; i < obj.length; i++) {
      string += handleInterpolation3(mergedProps, registered, obj[i]) + ";";
    }
  } else {
    for (var key in obj) {
      var value = obj[key];
      if (typeof value !== "object") {
        ...
        if (registered != null && registered[asString] !== void 0) {
          string += key + "{" + registered[asString] + "}";
        } else if (isProcessableValue5(asString)) {
          string += processStyleName3(key) + ":" + processStyleValue5(key, asString) + ";";
        }
      } else {
        if (key === "NO_COMPONENT_SELECTOR" && isDevelopment7) {
          throw new Error(noComponentSelectorMessage3);
        }
        if (Array.isArray(value) && typeof value[0] === "string" && (registered == null || registered[value[0]] === void 0)) {
          for (var _i = 0; _i < value.length; _i++) {
            if (isProcessableValue5(value[_i])) {
              string += processStyleName3(key) + ":" + processStyleValue5(key, value[_i]) + ";";
            }
          }
        } else {
          var interpolated = handleInterpolation3(mergedProps, registered, value);
          switch (key) {
            case "animation":
            case "animationName": {
              string += processStyleName3(key) + ":" + interpolated + ";";
              break;
            }
            default: {
              if (key === "undefined") {
                console.error(UNDEFINED_AS_OBJECT_KEY_ERROR3);
              }
              string += key + "{" + interpolated + "}";
            }
          }
...
var labelPattern3 = /label:\s*([^\s;{]+)\s*(;|$)/g;
var cursor3;
function serializeStyles3(args, registered, mergedProps) {
  if (args.length === 1 && typeof args[0] === "object" && args[0] !== null && args[0].styles !== void 0) {
    return args[0];
  }
  var stringMode = true;
  ...
  if (strings == null || strings.raw === void 0) {
    stringMode = false;
    styles += handleInterpolation3(mergedProps, registered, strings);
  } else {
    var asTemplateStringsArr = strings;
    if (asTemplateStringsArr[0] === void 0) {
      console.error(ILLEGAL_ESCAPE_SEQUENCE_ERROR4);
    }
    styles += asTemplateStringsArr[0];
  }
  for (var i = 1; i < args.length; i++) {
    styles += handleInterpolation3(mergedProps, registered, args[i]);
    if (stringMode) {
      var templateStringsArr = strings;
      if (templateStringsArr[i] === void 0) {
        console.error(ILLEGAL_ESCAPE_SEQUENCE_ERROR4);
  ...
  labelPattern3.lastIndex = 0;
  var identifierName = "";
  var match2;
  while ((match2 = labelPattern3.exec(styles)) !== null) {
    identifierName += "-" + match2[1];
  }
  var name = murmur2(styles) + identifierName;
  {
...
function internal_serializeStyles(styles) {
  wrapper[0] = styles;
  return serializeStyles3(wrapper);
}
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-4EJ63K4T.js.map
