...
const Signup = () => {
  ...
  const sendOtp = async () => {
    try {
      await axios.post('http://13.204.83.61:5000/api/auth/send-otp', { email });
  ...
  const verifyOtp = async () => {
    try {
      await axios.post('http://13.204.83.61:5000/api/auth/verify-otp', { email, otp });
  ...
  const setNewPassword = async (e) => {
    ...
    try {
      await axios.post('http://13.204.83.61:5000/api/auth/register', { email, password });
